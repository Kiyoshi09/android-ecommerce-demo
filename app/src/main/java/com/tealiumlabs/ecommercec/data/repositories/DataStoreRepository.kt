...
class DataStoreRepository @Inject constructor(
    ...
    suspend fun persistTealiumConfig(config: String) {
        dataStore.edit { preference ->
            preference[PreferenceKeys.tealiumConfig] = config
        }
    }

    val readTealiumConfig: Flow<String> = dataStore.data
        .catch { exception ->
        ...
        .map { preferences ->
            val configState = preferences[PreferenceKeys.tealiumConfig] ?: ""
            configState
        }
